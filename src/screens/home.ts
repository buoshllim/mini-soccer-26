...
export function mountHome(el: HTMLElement) {
  el.innerHTML = `
    <div style="text-align:center;padding:clamp(24px,6vw,48px) clamp(16px,5vw,32px);background:rgba(0,0,0,0.85);border-radius:16px;width:min(360px,90vw);box-sizing:border-box">
      ...
      <p style="color:#888;margin-bottom:32px;font-size:14px">Real-time 5v5 Chaos Soccer</p>
      ...
      <input id="room-code" placeholder="Enter 4-digit code" maxlength="4" inputmode="numeric" pattern="[0-9]*"
      ...
      />
      <style>#room-code::placeholder{font-size:18px;letter-spacing:0}</style>
